/** Javae Environment (Chaper 01)'
 * 
 * Java Development Kit (JDK)
 * Contain the minimum softwareyou need to do Java development.
 * Key pieces include:
 * - compoler (javac),
 * - launcher (java),
 * - archiver (jar),
 ...
 * The JRE was a subste of JDK that was used for running a program but could not compile one. 
 * People can use the full JDK when running a Java program.
 * 
 * 
